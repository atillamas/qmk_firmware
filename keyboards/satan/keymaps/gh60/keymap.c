...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----------------------------------------------------------|
   * |Ctrl|Gui |Alt |      Space            |Alt |FN  |RL  |Ctrl |
   * `-----------------------------------------------------------'
   */
[_BASE] = KEYMAP_ANSI(
  ...
  KC_LCTL, KC_LGUI, KC_LALT,                           KC_SPC,                             KC_RALT, MO(_FN), MO(_RL), KC_RCTL),
...
[_FN] = KEYMAP_ANSI(
  ...
  KC_TRNS, KC_TRNS, KC_UP,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_INS,  KC_TRNS, KC_TRNS, KC_INS,  KC_PSCR, KC_TRNS, \
